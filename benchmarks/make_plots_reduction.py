...
for th in num_thr:
    ...
    axes[1, 0].plot(msg_size, native_simple_dp, marker='*', label='Native DP')
    axes[0, 0].plot(msg_size, localhost_simple, marker='s', label='Localhost')
    axes[1, 0].plot(msg_size, localhost_simple_dp, marker='+', label='Localhost DP')
    axes[0, 0].plot(msg_size, racex_simple, marker='^', label='RACEX')
    axes[1, 0].plot(msg_size, racex_simple_dp, marker='v', label='RACEX DP')
    ...
    axes[1, 1].plot(msg_size, native_pcie_dp, marker='*', label='Native PCIe DP')
    axes[0, 1].plot(msg_size, localhost_pcie, marker='s', label='Localhost PCIe')
    axes[1, 1].plot(msg_size, localhost_pcie_dp, marker='+', label='Localhost PCIe DP')
    axes[0, 1].plot(msg_size, racex_pcie, marker='^', label='RACEX PCIe')
    axes[1, 1].plot(msg_size, racex_pcie_dp, marker='v', label='RACEX PCIe DP')
    ...
    axes[1, 2].plot(msg_size, native_parity_dp, marker='*', label='Native Parity DP')
    axes[0, 2].plot(msg_size, localhost_parity, marker='s', label='Localhost Parity')
    axes[1, 2].plot(msg_size, localhost_parity_dp, marker='+', label='Localhost Parity DP')
    axes[0, 2].plot(msg_size, racex_parity, marker='^', label='RACEX Parity')
    axes[1, 2].plot(msg_size, racex_parity_dp, marker='v', label='RACEX Parity DP')
