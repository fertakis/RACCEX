...
results = [f for f in listdir("/media/kepler/remotephiexec/scif_benchmarks/send_recv/results") 
if isfile(join("/media/kepler/remotephiexec/scif_benchmarks/send_recv/results", f))];
...
for t in msg_size:
    ...
    rac_ls=[]
    for x in range(1,11):
        f_native = open("/media/kepler/remotephiexec/scif_benchmarks/send_recv/results/run_native_" + str(t) +"_"+ str(x) +".out", "r")
        f_local = open("/media/kepler/remotephiexec/scif_benchmarks/send_recv/results/run_localhost_" + str(t) +"_"+ str(x) +".out", "r")
        f_racex = open("/media/kepler/remotephiexec/scif_benchmarks/send_recv/results/run_racex_" + str(t) +"_"+ str(x) +".out", "r")
